...
parser.add_argument('--dataset', default='diginetica', help='dataset name: diginetica/gowalla/lastfm')
...
def main():
    ...
    if opt.train_flag == "True":
        ...
        for epoch in range(opt.epoch):
            print('-------------------------------------------------------')
            print('epoch: ', epoch)
            hit, mrr, phi, [mrr_long, mrr_short, hit_long, hit_short] = train_test(model, train_data, test_data)
            flag = 0
        ...
        hit, mrr, phi, [mrr_long, mrr_short, hit_long, hit_short] = formal_test(model, train_data, test_data)
        print(hit)
        print(mrr)
